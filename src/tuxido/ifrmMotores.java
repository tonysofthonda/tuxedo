 ...
 * @author vj002349
 */
public class ifrmMotores extends javax.swing.JInternalFrame {
     JDesktopPane panel1;
    ...
    String id;
    /**
     * Creates new form ifrmMotores
     * @param jDesktopPane1 
     */
    public ifrmMotores(JDesktopPane jDesktopPane1) {
        initComponents();
    ...
    public void actualizar(){
        conexion();
        cnxO.consulta("select ID, MOTOR, APLICA, DESCRIPCION, CARACTERES, STATUS from TX_MOTOR");
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setResizable(true);
        setTitle("Tuxedo | Administracion Motores");
        setToolTipText("");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Motor", "Aplica", "Descripcion", "Caracteres", "Status"
            }
        ) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        ifrmAddMotor ifrmam=new ifrmAddMotor();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        ifrmModMotor ifrmmmtr=new ifrmModMotor(id);
        Dimension desktopSize = panel1.getSize();
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        conexion();
        cnxO.ejecutar("update TX_MOTOR SET status='"+status+"' where id='"+id+"'");
        desconexion();
        actualizar();
