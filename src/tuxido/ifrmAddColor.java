 ...
 * @author vj002349
 */
public class ifrmAddColor extends javax.swing.JInternalFrame {
    conexionPostgres cnxO;
    /**
     * Creates new form ifrmAddColor
     */
    public ifrmAddColor() {
        initComponents();
        modelos();
    ...
    public void insertar(){
        ...
        if(codigo.getText().length()>0&&color.getText().length()>0){
            cnxO.ejecutar("insert into TX_COLOR VALUES('"+codigo.getText()+"','"+color.getText()+"','"+aplica.getSelectedItem().toString()+"','"+status.getSelectedItem().toString()+"')");
