 ...
 * @author vj002349
 */
public class ifrmWPModModelo extends javax.swing.JInternalFrame {
    conexionWPPostgre cnxO;
    String ind;
    /**
     * Creates new form ifrmWPModModelo
     */
    public ifrmWPModModelo(String id) {
        initComponents();
        ind=id;
        informacion();
    }
    ...
    public void informacion(){
        conexion();
        cnxO.consulta("select * from WP_MODELO WHERE id="+ind+"");
        try {
            while(cnxO.reg.next()){
            ...
            Logger.getLogger(ifrmWPModModelo.class.getName()).log(Level.SEVERE, null, ex);
        }
        desconexion();
    }
    /**
    ...
    public void guardar(){
        conexion();
              ...
              if(pref.getText().length()==4){
                        cnxO.ejecutar("update WP_MODELO SET codigo_modelo='"+cmodelo.getText()+"' WHERE id='"+ind+"'");
                        cnxO.ejecutar("update WP_MODELO SET descripcion='"+desc.getText()+"' WHERE id='"+ind+"'");
                        cnxO.ejecutar("update WP_MODELO SET anio='"+anio.getText()+"' WHERE id='"+ind+"'");
                        cnxO.ejecutar("update WP_MODELO SET prefijo='"+pref.getText()+"' WHERE id='"+ind+"'");
                        cnxO.ejecutar("update WP_MODELO SET ini_serie_prod='"+serieprod.getText()+"' WHERE id='"+ind+"'");
                        cnxO.ejecutar("update WP_MODELO SET ini_serie_emp='"+serieemp.getText()+"' WHERE id='"+ind+"'");
