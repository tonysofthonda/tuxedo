 ...
 * @author vj002349
 */
public class ifrmWPRepEmbarque extends javax.swing.JInternalFrame {
    int fila;
    ...
    private String fa;
    /**
     * Creates new form ifrmWPRepEmbarque
     */
    public ifrmWPRepEmbarque(JDesktopPane jDesktopPane) {
        panel = jDesktopPane;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Tuxedo - WaterPump |  Bitácora de Embarque");
        setToolTipText("");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        ifrmWPEmbarque ifrmemb=new ifrmWPEmbarque();
