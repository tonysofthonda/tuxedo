 ...
 * @author vj002349
 */
public class ifrmTransportistas extends javax.swing.JInternalFrame {
    JDesktopPane panel1;
    ...
    /**
     * Creates new form ifrmTransportistas
     * @param jDesktopPane1 
     */
    public ifrmTransportistas(JDesktopPane jDesktopPane1) {
        initComponents();
    ...
    public void actualizar(){
        conexion();
                cnx.consulta("select * from TX_LN_TRANS");
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Tuxedo | Transportistas");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        ifrmAddLinea ifrmln=new ifrmAddLinea();
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        conexion();
            cnx.ejecutar("update TX_LN_TRANS SET status='"+status+"' where id='"+id+"'");
        desconexion();
        actualizar();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        id=jTable1.getValueAt(fila, 0).toString();
        ifrmModLinea ifrmmln=new ifrmModLinea(id);
        Dimension desktopSize = panel1.getSize();
