 ...
 * @author vj002349
 */
public class ifrmColor extends javax.swing.JInternalFrame {
    JDesktopPane panel1;
    ...
    /**
     * Creates new form ifrmColor
     * @param jDesktopPane1 
     */
    public ifrmColor(JDesktopPane jDesktopPane1) {
        initComponents();
    ...
    public void actualizar(){
        conexion();
                        cnxO.consulta("select * from TX_COLOR");
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setResizable(true);
        setTitle("Tuxedo | Administracion de Colores");
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jToolBar1, javax.swing.GroupLayout.DEFAULT_SIZE, 184, Short.MAX_VALUE)
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        ifrmAddColor ifrmac=new ifrmAddColor();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        color=jTable1.getValueAt(fila, 0).toString();
        ifrmModColor ifrmmc=new ifrmModColor(color);
        Dimension desktopSize = panel1.getSize();
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        conexion();
        cnxO.ejecutar("update TX_COLOR SET status='"+status+"' where codigo='"+color+"'");
        desconexion();
        actualizar();
