 ...
 * @author vj002349
 */
public class ifrmModMotor extends javax.swing.JInternalFrame {
    conexionPostgres cnxO;
    String idn;
    String opc;
    /**
     * Creates new form ifrmModMotor
     * @param id 
     */
    public ifrmModMotor(String id) {
        initComponents();
        idn=id;
        informacion();
    ...
    public void informacion(){
        conexion();
        cnxO.consulta("select * from TX_MOTOR WHERE id='"+idn+"'");
        try {
            while(cnxO.reg.next()){
            ...
            Logger.getLogger(ifrmModMotor.class.getName()).log(Level.SEVERE, null, ex);
        }
        desconexion();
        modelos();
    }
    ...
    public void infomod(String opcn){
        conexion();
        cnxO.consulta("select descripcion from TX_MODELO where status='Activo' and codigo_modelo='"+opcn+"'");
        try {
            while(cnxO.reg.next()){
    ...
    public void actualizar(){
        ...
        if(codigo.getText().length()>0&&numCar.getText().length()>0){
            cnxO.ejecutar("UPDATE TX_MOTOR SET motor='"+codigo.getText()+"' where id='"+idn+"'");
            cnxO.ejecutar("UPDATE TX_MOTOR SET aplica='"+aplica.getSelectedItem().toString()+"' where id='"+idn+"'");
            cnxO.ejecutar("UPDATE TX_MOTOR SET descripcion='"+desc.getText()+"' where id='"+idn+"'");
            cnxO.ejecutar("UPDATE TX_MOTOR SET caracteres='"+numCar.getText()+"' where id='"+idn+"'");
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Tuxedo | Modificar Motor");
